...
class Crypt
{
    ...
    const ERROR_INVALID_AESKEY = -40004;
    const ERROR_INVALID_APPID = -40005; // 校验签名失败
    const ERROR_ENCRYPT_AES = -40006; // 解析xml失败
    const ERROR_DECRYPT_AES = -40007; // 计算签名失败
    const ERROR_INVALID_XML = -40008; // 不合法的AESKey
    const ERROR_BASE64_ENCODE = -40009; // 校验AppID失败
    const ERROR_BASE64_DECODE = -40010; // AES加密失败
    const ERROR_XML_BUILD = -40011; // AES解密失败
    /**
     * 应用ID
     *
     * @var string
     */
    protected $appId; // 公众平台发送的xml不合法
    /**
     * 应用token
     *
     * @var string
     */
    protected $token; // Base64编码失败
    /**
     * 加密用的AESkey
     *
     * @var string
     */
    protected $AESKey; // Base64解码失败
    /**
     * 块大小
     *
     * @var int
     */
    protected $blockSize; // 公众帐号生成回包xml失败
